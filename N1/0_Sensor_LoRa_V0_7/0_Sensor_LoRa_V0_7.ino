...
/*
DEFINIR OS PINOS PINOS PARA O NODEMCU
*/
...
// ============== CAMADA MAC
#define TAMANHO_PACOTE 14
byte PacoteDL[TAMANHO_PACOTE];
byte PacoteUL[TAMANHO_PACOTE];
int tempo_entre_medidas;
// ============= TIMEOUT
unsigned long timeout_ms = 2000;          // tempo limite padrão (5 segundos)
unsigned long last_packet_time = 0;       // momento do último pacote recebido
bool timeout_flag = false;                // flag de timeout
